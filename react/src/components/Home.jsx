              ...
              <table className="table table-gradient">
                ...
                <tbody>
                  {[searchResults].map((stock) => (
                    <tr key={stock._itemId}>
                      <td>{stock._itemId}</td>
                      <td>{stock._stockName}</td>
                      <td>{stock._price}</td>
                      <td>{stock._quantity}</td>
                      <td>{stock._amount}</td>
                      <td>{stock._supplier}</td>
                      <td>{stock._orderCompletionDate}</td>
                      <td className={getStatusColor(stock._status)}>
                        {stock._status}
                      </td>
                      {/* Add other columns as needed */}
                    </tr>
